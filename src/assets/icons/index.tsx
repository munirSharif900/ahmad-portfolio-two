...
export function CodeIcon({ className = "w-5 h-5" }: Props) {
  return (
...
export function ServerIcon({ className = "w-5 h-5" }: Props) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function DjangoIcon({ className = "w-5 h-5" }: Props) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="#44b78b">
      <path d="M11.146 0h3.924v18.166c-2.013.382-3.491.535-5.096.535-4.791 0-7.288-2.166-7.288-6.32 0-4.002 2.65-6.6 6.753-6.6.637 0 1.121.05 1.707.203zm0 9.143a3.894 3.894 0 0 0-1.325-.204c-1.988 0-3.134 1.223-3.134 3.365 0 2.09 1.096 3.236 3.109 3.236.433 0 .79-.025 1.35-.102V9.142zM21.314 6.06v11.109c0 3.849-.28 5.695-1.096 7.288-.764 1.543-1.783 2.523-3.876 3.596l-3.646-1.73c2.093-1.02 3.112-1.923 3.75-3.314.663-1.42.893-3.04.893-7.314V6.059h3.975zM17.339 0h3.975v4.02h-3.975z" />
    </svg>
  );
}
